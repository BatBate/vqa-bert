...
if __name__ == '__main__':
    ...
    # print("printing name and parameters in question_embedding_models")
    # for n ,p in model.question_embedding_models.named_parameters():
    #     print(n, p)
    ...
    param_optimizer = list(model.question_embedding_models.named_parameters())
    ...
    bert_optimizer = BertAdam(optimizer_grouped_parameters,
                         lr=5e-5,
                         warmup=0.1,
                         t_total=cfg.training_parameters.max_iter)
    ...
    one_stage_train(my_model,
                    data_reader_trn,
                    my_optim, bert_optimizer, my_loss, data_reader_eval=data_reader_val,
