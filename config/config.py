...
__C.data.pretrained_bert_dir = '/u/lxiao/VQA/pythia/pretrained_bert'

__C.data.data_root_dir = "/u/shirlywang/vqa/pythia/data"

__C.data.vocab_question_file = "vocabulary_vqa.txt"
__C.data.vocab_answer_file = "answers_vqa.txt"

__C.data.image_feat_train = ["features/train"]
__C.data.imdb_file_train = ["imdb/imdb_train2014.npy"]

__C.data.imdb_file_val = ["imdb/imdb_val2014.npy"]
__C.data.image_feat_val = ["features/val"]

__C.data.imdb_file_test = ["imdb/imdb_test2015.npy"]
__C.data.image_feat_test = ["features/test"]
...
__C.model.question_embedding = [ModelParPair("bert_embed")]
